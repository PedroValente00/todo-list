         ...
         <form className='auth-form' onSubmit={handleSubmit(onSubmit)}>
            ...
            <fieldset>
                ...
                <section>
                    ...
                    {(errors.name && errors.name.type === "minLength") && <div className='auth-error-message'>Name must be longer.</div>}
                    {(errors.name && errors.name.type === "maxLength") && <div className='auth-error-message'>Name must 20 characters or less.</div>}
